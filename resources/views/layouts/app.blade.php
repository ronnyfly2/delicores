...
<html lang="{{ app()->getLocale() }}">
  <head>
    ...
    <link href="/css/all.css?ver=1534485157415" media="all" rel="stylesheet" type="text/css">
  ...
  <body>@if (Session::has('flash_notification.message'))
    ...
    <!-- coment-->@include('layouts.bones.header')
    @yield('content')
    @include('layouts.bones.footer')
    ...
    <script src="{{ asset('js/libs/jquery/dist/jquery.min.js') }}?ver=1534485157416" type="text/javascript"></script>
    <script data-main="/js/main.js?ver=1534485157416" src="{{ asset('js/libs/requirejs/require.js') }}?ver=1534485157416"></script>
  </body>
</html>